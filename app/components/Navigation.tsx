    ...
    <nav aria-label="Main navigation" className="flex items-center gap-5 sm:gap-6 lg:gap-8 flex-wrap justify-center">
      {NAV_ITEMS.map((item, index) => (
        <motion.a
          ...
          className="text-black text-base sm:text-base font-medium focus:outline-none px-3 py-2 cursor-pointer transition-colors duration-300 hover:text-gray-600 touch-manipulation"
